...
#ifndef _aspect_postprocess_cell_values_h
#define _aspect_postprocess_cell_values_h
...
namespace aspect
{
  namespace Postprocess
  {
     ...
     */
    template <int dim>
    class CellValues : public Interface<dim>, public ::aspect::SimulatorAccess<dim>
    {
      public:
        /**
         * Constructor
      ...
      private:
        ...
        struct OneTimeStepData
        {
          unsigned int time_step_no;
          double time;
          std::vector<Vector<double>> data;
        };

        std::vector<OneTimeStepData> data;
    };
  }
}
