...
#ifndef _aspect_postprocess_sampled_output_h
#define _aspect_postprocess_sampled_output_h

#include <aspect/postprocess/interface.h>
#include <aspect/simulator_access.h>

#include <aspect/sampled.h>
...
namespace aspect
{
  namespace Postprocess
  {
     ...
     */
    template <int dim>
    class SampledOutput : public Interface<dim>, public ::aspect::SimulatorAccess<dim>
    {
      public:
        /**
         * Constructor
