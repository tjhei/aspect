...
*/
/*  $Id: interface.cc 1890 2013-09-13 09:32:35Z dannberg $  */
...
// -------------------------------- their setup and selection at run time
                               ...
                               const GeometryModel::Interface<dim> &geometry_model)
    {
      ...
      prm.enter_subsection ("Porosity initial conditions");
      {
      ...
      Interface<dim> *plugin = std_cxx1x::get<dim>(registered_plugins).create_plugin (model_name,
                                                                                      "Porosity initial conditions::Model name",
                                                                                      prm);
...
namespace aspect
{
  namespace internal
  {
    ...
    {
      template <>
      std::list<internal::Plugins::PluginList<PorosityInitialConditions::Interface<2> >::PluginInfo> *
      internal::Plugins::PluginList<PorosityInitialConditions::Interface<2> >::plugins = 0;
      template <>
      std::list<internal::Plugins::PluginList<PorosityInitialConditions::Interface<3> >::PluginInfo> *
      internal::Plugins::PluginList<PorosityInitialConditions::Interface<3> >::plugins = 0;
    }
  }
